...
class LatinStyle {
  ...
  static TextStyle createTextStyle({
    ...
    return TextStyle(
      ...
      backgroundColor: latinProperties.backgroundColor ?? baseProperties.backgroundColor,
      ...
      letterSpacing: latinProperties.letterSpacing ?? baseProperties.letterSpacing,
      ...
      leadingDistribution: latinProperties.leadingDistribution ?? baseProperties.leadingDistribution,
      ...
      fontVariations: latinProperties.fontVariations ?? baseProperties.fontVariations,
      decoration: latinProperties.decoration ?? baseProperties.decoration,
      decorationColor: latinProperties.decorationColor ?? baseProperties.decorationColor,
      decorationStyle: latinProperties.decorationStyle ?? baseProperties.decorationStyle,
      decorationThickness: latinProperties.decorationThickness ?? baseProperties.decorationThickness,
      fontFamily: latinProperties.fontFamily ?? FontRegistry.getDefaultFontFamily(ScriptType.latin),
      fontFamilyFallback: latinProperties.fontFamilyFallback ?? FontRegistry.getFontFallbacks(ScriptType.latin),
